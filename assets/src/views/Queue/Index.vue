...
.stat-icon-bg.waiting { background: linear-gradient(135deg, var(--asmaa-warning) 0%, #d97706 100%); }
.stat-icon-bg.serving { background: linear-gradient(135deg, var(--asmaa-info) 0%, #0284c7 100%); }
